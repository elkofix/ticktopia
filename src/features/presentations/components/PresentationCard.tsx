...
export default function PresentationCard({ presentation, bannerPhotoUrl, name }: PresentationCardProps) {
  ...
  return (
    <div className="group flex flex-col md:flex-row bg-gray-50 rounded-lg overflow-hidden hover:shadow-md transition-all duration-200 hover:bg-gray-100">
      {/* Presentation Banner */}
      ...
      <div className="flex-1 p-4 md:p-6 flex flex-col lg:flex-row justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="space-y-2">
            <div className="flex items-center text-gray-600">
              ...
              <span className="text-sm font-medium line-clamp-1">{formateDate(presentation.startDate)}</span>
            </div>
        ...
        <div className="flex-shrink-0 self-end md:self-center">
          <Link href={`/presentation/${presentation.idPresentation}`} className="inline-block min-w-[150px]">
